...
public class ComponentTypePostProcessor {
     ...
     *
     * @param tadm the TechnologyAgnosticDeploymentModel to process, i.e. the result from the MPS transformation
     * @return the processed TechnologyAgnosticDeploymentModel with merged ComponentTypes
     */
    public static TechnologyAgnosticDeploymentModel mergeDuplicateComponentTypes(TechnologyAgnosticDeploymentModel tadm) {
